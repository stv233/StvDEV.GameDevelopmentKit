...
namespace StvDEV.GDK.Components.Scenarios
{
    /// <summary>
    /// Events Scenario Component.
    /// </summary>
    [AddComponentMenu("StvDEV/Game Development Kit/Scenarios/Scenario")]
    [HelpURL("https://docs.stvdev.pro/StvDEV/GDK/Components/Scenarios/Scenario/index.html")]
    public class Scenario : MonoBehaviour
    {
        ...
        [Header("Settings")]
        [CaptionedBool("Yes", "No"), Tooltip("Run the scenario at startup.")]
