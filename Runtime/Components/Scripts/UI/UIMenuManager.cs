...
namespace StvDEV.GDK.Components.UI
{
    /// <summary>
    /// GUI Menu Management Manager.
    /// </summary>
    [AddComponentMenu("StvDEV/Game Development Kit/UI/UI Menu Manager")]
    [HelpURL("https://docs.stvdev.pro/StvDEV/GDK/Components/UI/UIMenuManager/index.html")]
    public class UIMenuManager : Manager<UIMenuManager>
    {
