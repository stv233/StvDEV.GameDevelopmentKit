...
namespace StvDEV.GDK.Components.UI.Dialogs
{
    ...
    /// Gloabal message box.
    /// </summary>
    [AddComponentMenu("StvDEV/Game Development Kit/UI/Dialogs/Message Box")]
    [HelpURL("https://docs.stvdev.pro/StvDEV/GDK/Components/UI/Dialogs/MessageBox/index.html")]
