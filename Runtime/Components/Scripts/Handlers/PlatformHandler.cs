using StvDEV.GDK.Inspector;
using StvDEV.GDK.Patterns;
using UnityEngine;
using UnityEngine.Events;

namespace StvDEV.GDK.Components.Handlers
{
    /// <summary>
    /// Component for handle current platform.
    /// </summary>
    [AddComponentMenu("StvDEV/Game Development Kit/Basic/Handlers/Platform Handler")]
    [HelpURL("https://docs.stvdev.pro/StvDEV/GDK/Components/Handlers/PlatformHandler/index.html")]
    public class PlatformHandler : Manager<PlatformHandler>
    {
        /// <summary>
