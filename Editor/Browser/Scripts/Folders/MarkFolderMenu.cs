...
namespace StvDEV.GDK.Editor.Browser.Folders
{
    /// <summary>
    /// Folders menu items.
    /// </summary>
    internal static class MarkFolderMenu
    {
        ...
        [MenuItem(PARENT_MENU + "/Default", priority = 1150)]
